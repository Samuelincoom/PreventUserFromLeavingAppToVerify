    ...
    private class paymentTabAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            if (position == LOADING){
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(PayWithSlydepay.this);

                builder.setTitle("Do this action");
                builder.setMessage("If you use MTN, Click MTN to Approve your purchase before you can move forward..  If you use any other network or forms of payment, click OTHER");

                builder.setPositiveButton("MTN", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        String number = "*170";
                        String hashkey = "#";
                        Uri call = Uri.parse("tel:" + number + hashkey);
                ...
                builder.setNegativeButton("Other Networks", new DialogInterface.OnClickListener() {
